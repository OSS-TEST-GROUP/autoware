...
COMPONENT_ROWS = [
    ...
    ("Perception", "Sensing", "주요 기능", "src/sensor_component\nsrc/sensor_kit\nsrc/universe/autoware.universe/sensing", "virtual_lidar_detection.launch.xml", "가상 LiDAR Pointcloud 축소 및 차량 영역 제거"),
    ...
    ("Perception", "Perception", "주요 기능", "src/universe/autoware.universe/perception\ndummy perception 보완 패키지", "perception_simulator_component.launch.xml\nvirtual_lidar_detection.launch.xml", "CPU 군집화, 객체 형상 추정·추적·예측"),
...
COMPONENT_SUMMARY_ROWS = [
    ...
    ("Perception", "Sensing", "가상 LiDAR 전처리 사용", "RViz 장애물 Pointcloud의 voxel downsample과 차량 영역 제거를 CPU로 처리"),
    ("Perception", "Localization", "현재 시험에서는 Simulator로 대체", "실차 환경에서 차량 위치·자세와 좌표계를 추정"),
    ("Perception", "Perception", "가상 LiDAR CPU 검출 사용", "전처리 Pointcloud를 군집화하고 형상 추정·추적·예측 객체로 변환"),
...
MODULE_ROWS = [
    ...
    ("Perception", "Sensing", "autoware_pointcloud_preprocessor", "활성", "/sensing/lidar/virtual/pointcloud_raw", "/sensing/lidar/concatenated/pointcloud\n/perception/obstacle_segmentation/pointcloud", "전체 tier4_sensing_launch 대신 가상 LiDAR voxel 및 차량 영역 제거 노드만 실행", "virtual_lidar_detection.launch.xml"),
    ...
    ("Perception", "Dummy detection", "autoware_dummy_perception_publisher", "활성", "/simulation/dummy_perception_publisher/object_info\n/tf", "/sensing/lidar/virtual/pointcloud_raw\n/simulation/dummy_perception_publisher/output/debug/ground_truth_objects", "RViz DummyObject를 LiDAR 필드가 포함된 가상 Pointcloud로 변환", "obigo_dummy_perception_publisher.launch.xml"),
    ("Perception", "CPU clustering", "autoware_euclidean_cluster", "활성", "/perception/obstacle_segmentation/pointcloud", "/perception/object_recognition/detection/labeled_clusters", "전처리 Pointcloud를 CPU Euclidean 방식으로 군집화", "virtual_lidar_detection.launch.xml"),
...
NODE_DETAILS = {
    ...
    ("Perception", "CPU clustering"): ("Perception", "autoware_euclidean_cluster", "/perception/object_recognition/detection/virtual_lidar_euclidean_cluster"),
...
TOPIC_ROWS_BASE = [
    ...
    ("T02A", "Perception", "Virtual LiDAR", "/sensing/lidar/virtual/pointcloud_raw", "sensor_msgs/msg/PointCloud2", "dummy_perception_publisher", "voxel_grid_downsample_filter_node", "Perception -> Sensing", "주 경로", "LiDAR 필드가 포함된 가상 원시 점군"),
    ("T02B", "Perception", "Sensing", "/sensing/lidar/concatenated/pointcloud", "sensor_msgs/msg/PointCloud2", "voxel_grid_downsample_filter_node", "crop_box_filter_node", "Sensing 내부", "주 경로", "voxel 축소 점군"),
    ("T03", "Perception", "Pointcloud", "/perception/obstacle_segmentation/pointcloud", "sensor_msgs/msg/PointCloud2", "crop_box_filter_node", "CPU clustering, Decision planners, Control AEB/checkers", "Sensing -> Perception/Decision/Control", "주 경로 + 안전", "차량 영역이 제거된 장애물 점군"),
    ("T04", "Perception", "Detection", "/perception/object_recognition/detection/labeled_clusters", "tier4_perception_msgs/msg/DetectedObjectsWithFeature", "virtual_lidar_euclidean_cluster", "shape_estimation", "Perception 내부", "주 경로", "CPU 군집화 검출"),
...
CONNECTION_ROWS = [
    ...
    (
        ...
        "Perception", "Sensing",
        "autoware_pointcloud_preprocessor", "/sensing/lidar/virtual/voxel_grid_downsample_filter_node",
        "Subscription", "/sensing/lidar/virtual/pointcloud_raw",
        "RViz 객체 형상을 LiDAR 필드가 포함된 가상 Pointcloud로 변환",
        "src/universe/autoware.universe/obigo_launch/launch/components/virtual_lidar_detection.launch.xml",
    ),
    (
        "P03", "센서 전처리",
        "Perception", "Sensing",
        "autoware_pointcloud_preprocessor", "/sensing/lidar/virtual/voxel_grid_downsample_filter_node", "Publisher",
        "/sensing/lidar/concatenated/pointcloud",
        "sensor_msgs/msg/PointCloud2",
        "Perception", "Sensing",
        "autoware_pointcloud_preprocessor", "/sensing/lidar/virtual/crop_box_filter_node",
        "Subscription", "/sensing/lidar/concatenated/pointcloud",
        "Pointcloud를 voxel 단위로 축소한 뒤 차량 자체 영역 제거 단계로 전달",
        "src/universe/autoware.universe/obigo_launch/launch/components/virtual_lidar_detection.launch.xml",
    ),
    (
        "P04", "센서 전처리",
        "Perception", "Sensing",
        "autoware_pointcloud_preprocessor", "/sensing/lidar/virtual/crop_box_filter_node", "Publisher",
        "/perception/obstacle_segmentation/pointcloud",
        "sensor_msgs/msg/PointCloud2",
        "Perception", "Perception",
        "autoware_euclidean_cluster", "/perception/object_recognition/detection/virtual_lidar_euclidean_cluster",
        "Subscription", "/perception/obstacle_segmentation/pointcloud",
        "차량 영역이 제거된 장애물 Pointcloud를 CPU Euclidean 군집화로 전달",
        "src/universe/autoware.universe/obigo_launch/launch/components/virtual_lidar_detection.launch.xml",
    ),
    (
        "P05", "주 경로",
        "Perception", "Perception",
        "autoware_euclidean_cluster", "/perception/object_recognition/detection/virtual_lidar_euclidean_cluster", "Publisher",
        ...
        "CPU 군집화 결과를 UNKNOWN 객체 클러스터로 만들고 형상을 추정",
        "src/universe/autoware.universe/obigo_launch/launch/components/virtual_lidar_detection.launch.xml",
    ),
    (
        "P06", "주 경로",
    ...
    (
        ...
        "/sensing/lidar/virtual/crop_box_filter_node",
        "Publisher",
        "/perception/obstacle_segmentation/pointcloud",
        "sensor_msgs/msg/PointCloud2",
        "Control", "Control",
